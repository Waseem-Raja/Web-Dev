        ...
        switch (num) {
            case 0:
                if (opposite == 0 && num == 0)
                    ...
                    document.getElementById("view").value = "Computer  Won  you choose rock and computer choose scissor \n (rock crushes scissor)";
                else if (opposite == 2 && num == 0)
                    document.getElementById("view").value = "You  Won you choose rock and computer choose paper \n(paper covers rock)";
                break;
            case 1:
                if (opposite == 0 && num == 1)
